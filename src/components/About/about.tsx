        ...
        <div className="w-full h-full" ref={container} >
            ...
            <div className="w-full h-1/2 flex relative lg:translate-y-[95px] xl:translate-y-0 " >
                ...
                <div className="w-1/2 h-full py-[150px] px-10 flex flex-col gap-5" >
                    ...
                    <p id="websiteParagraph" className="text-[#1E1E1E] opacity-0 translate-x-[-100%] text-xl pr-14 font-lg leading-[35px] " >
            ...
            <div className="w-full h-1/2 flex xl:translate-y-0 lg:translate-y-[175px] " >
                ...
                <div className="w-1/2 h-full px-10 flex flex-col gap-5 items-end overflow-hidden" >
                    ...
                    <p id="cs22Paragraph" className="font-lg text-xl leading-[35px] opacity-0 translate-x-[200%] text-[#1E1E1E] pl-14 text-right" >
